Pod::Spec.new do |spec|
    ...
    spec.source             = { :http => 'https://github.com/Prado-SDK/prado-ios-frameworks/raw/main/mediation/ironSource/2.1.0/PradoIronSourceAdapter-2.1.0.zip' }
    spec.swift_version      = "5.3"
    spec.dependency 'IronSourceSDK', '>= 7.6.0.0'
    spec.dependency 'PradoSDK', '>= 10.0.3'
