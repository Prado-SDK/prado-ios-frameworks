Pod::Spec.new do |spec|
    ...
    spec.source             = { :http => 'https://github.com/Prado-SDK/prado-ios-frameworks/raw/main/mediation/applovin/2.0.1/PradoApplovinAdapter-2.0.1.zip' }
    spec.swift_version      = "5.3"
	spec.dependency 'AppLovinSDK', '>= 11.4.4'
    spec.dependency 'PradoSDK', '>= 10.0.1'
